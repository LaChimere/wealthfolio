...
| rust-service-bridge    | in_progress | Connect Electron to existing Rust-backed services, SQLite data dir behavior, and domain event streams.                        | Sidecar lifecycle, account/settings proxy, authenticated SSE event bridge, and portfolio dashboard proxy coverage passed tests. |
