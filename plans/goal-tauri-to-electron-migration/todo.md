...
| rust-service-bridge    | in_progress | Connect Electron to existing Rust-backed services, SQLite data dir behavior, and domain event streams.                        | Sidecar lifecycle, account/settings, portfolio, snapshots/imports, activities, exchange rates, goals, and retirement proxy tests passed. |
