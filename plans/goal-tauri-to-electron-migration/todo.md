...
| rust-service-bridge    | in_progress | Connect Electron to existing Rust-backed services, SQLite data dir behavior, and domain event streams.                        | Sidecar lifecycle, account CRUD, settings read/update/auto-update preference proxy, redaction, validation, and tests passed. |
