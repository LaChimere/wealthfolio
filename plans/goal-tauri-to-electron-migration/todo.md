...
| bun-tooling            | in_progress | Move JS package management/scripts to Bun and introduce Biome/Lefthook with minimal churn.                                    | Bun package manager/scripts/docs migrated and validated; Biome/Lefthook remains for the next tooling slice. |
