...
- [ ] PR 5+: Domain vertical slices.
  ...
  - Evidence: settings, accounts, contribution limits, taxonomy, custom
    ...
    option-expiry adjustments, split preprocessing, and lot-level asset
    transfers now run in the standalone TS runtime, while non-option adjustment
    parity and remaining complex activity replay move to portfolio/calculation
    ...
    rebuilding, option-expiry adjustments, split preprocessing, and lot-level
    asset-transfer replay now have TS runtime parity, while non-option
    adjustment handling is deferred to portfolio parity slices; asset
    ...
    option-expiry adjustments, split preprocessing, and lot-level asset-transfer
    replay now have TS runtime parity, while provider-backed symbol
    fetch/resolution and non-option adjustment handling are deferred to
    ...
    market-data sync now have TS runtime parity, while all-provider sync,
    background orchestration, and portfolio recalculation behavior remain
    deferred to market-data/portfolio parity slices; market-sync result
    accounting and portfolio `market:sync-complete` failure/skipped-reason
    payloads now have TS parity; activity mutation event production,
...
- Outcome: PR 1 contract foundation, PR 2 guarded TS backend runtime skeleton,
  ...
  replay, split preprocessing, lot-level asset-transfer replay, and market-sync
...
- Follow-ups: continue other low-risk domain slices; broader health
  ...
  adjustment handling and background portfolio worker orchestration move with
