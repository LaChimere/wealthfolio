...
- [ ] PR 5+: Domain vertical slices.
  ...
  - Evidence: settings, accounts, contribution limits, taxonomy, custom
    ...
    preparation, and deterministic retirement calculation primitives now have
    bounded TS runtime parity while retirement overview/projection/simulation
    execution remains deferred to calculation-heavy slices; automatic FX market
