...
- [ ] PR 5+: Domain vertical slices.
  ...
  - Evidence: settings, accounts, contribution limits, taxonomy, custom
    ...
    extraction/install, permission detection/merging, and staged ZIP install now
    have TS runtime parity, while add-on security scanning, sandbox host
    hardening, store HTTP/download staging, and update behavior are deferred to
...
- Outcome: PR 1 contract foundation, PR 2 guarded TS backend runtime skeleton,
  ...
  add-on filesystem runtime with Rust-compatible manifest normalization and
  local ZIP archive extraction/install/staging install, and explicit
  portfolio/market-sync deferred runtime gates implemented; broader migration
  remains active.
- Follow-ups: continue other low-risk domain slices; broader health
  ...
  security scanning, sandbox host hardening, store HTTP/download staging, and
  update behavior move with add-on runtime parity slices; provider-backed asset
