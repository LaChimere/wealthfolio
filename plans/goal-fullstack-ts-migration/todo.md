...
- [ ] PR 5+: Domain vertical slices.
  ...
  - Evidence: settings, accounts, contribution limits, taxonomy, custom
    ...
    overview assembly, HTTP retirement overview routing, and plan-backed
    retirement summary refresh now have bounded TS runtime parity while
...
- Outcome: PR 1 contract foundation, PR 2 guarded TS backend runtime skeleton,
  ...
  routing, plan-backed retirement summary refresh, bounded health status/check
  slices, bounded health classification-fix runtime, and bounded
